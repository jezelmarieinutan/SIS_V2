...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="MSU-IIT STUDENT INFORMATION SYSTEM", font=("Courier New", 30))
        label.place(x=230,y=20)

        home = tk.Button(self, text="HOME",font=("Courier New",16,"bold"),bd=0, width = 10, bg="#FF9900", fg="black", command=lambda: controller.show(Home))
        home.place(x=380,y=300)
        home.config(cursor= "hand2")
        
        course = tk.Button(self, text="COURSES",font=("Courier New",16,"bold"),bd=0, width = 10, bg="#FF9900", fg="black", command=lambda: controller.show(Courses))
        course.place(x=568,y=300)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Courier New",16,"bold"),bd=0, width = 13, bg="#FF9900", fg="black", command=lambda: controller.show(Students))
        students.place(x=750,y=300)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Courier New",15,"bold"),bd=0, width = 10, bg="#FF9900", fg="black", command=iExit)
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="COURSES", font=("Courier New", 40))
        ...
        home = tk.Button(self, text="HOME",font=("Courier New",13,"bold"),bd=0, width = 10, bg="#FF9900", fg="black", command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.lblccode = Label(self, font=("Courier New", 13, "bold"), text="Course Code:", padx=5, pady=5)
        ...
        self.lblcname = Label(self, font=("Courier New", 13,"bold"), text="Course Name:", padx=5, pady=5)
        ...
        self.SearchBar = Entry(self, font=("Courier New", 13), textvariable=SearchBar_Var, bd=0,bg="black",width=31)
        ...
        self.adds = Button(self, text="ADD", font=('Courier New', 11, ), height=1, width=10, bd=1, bg="#FF9900", fg="black",command=add_course)
        self.adds.place(x=460,y=300)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Courier New', 11), height=1, width=10, bd=1, bg="#FF9900", fg="black", command=update_course) 
        self.update.place(x=460,y=360)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Courier New', 11), height=1, width=10, bd=1, bg="#FF9900", fg="black", command=clear)
        self.clear.place(x=460,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Courier New', 11), height=1, width=10, bd=1, bg="#FF9900", fg="black", command=delete_course)
        self.delete.place(x=460,y=480)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Courier New', 11, 'bold'),bd=0, bg= "#FF9900", fg="black", command=search_course)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Courier New', 11, 'bold'), height=1, width=11, bg="#FF9900", fg="black", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="REGISTRATION FORM ", font=("Courier New", 50))
        label.place(x=130,y=20)
        
        home = tk.Button(self, text="HOME",font=("Courier New",12,"bold"),bd=0, width = 7, bg="#FF9900", fg="black",  command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.lblid = Label(self, font=("Courier New", 13,"bold"), text="ID Number:", padx=5, pady=5)
        self.lblid.place(x=125,y=144)
        self.txtid = Entry(self, font=("Courier New", 13, "bold"), textvariable=Student_ID, width=33)
        self.txtid.place(x=255,y=150)

        self.lblname = Label(self, font=("Courier New", 13,"bold"), text="Name:", padx=5, pady=5)
        self.lblname.place(x=125,y=205)
        self.txtname = Entry(self, font=("Courier New", 13, "bold"), textvariable=Student_Name, width=33)
        ...
        self.lblyear = Label(self, font=("Courier New", 13,"bold"), text="Year Level:", padx=5, pady=5)
        self.lblyear.place(x=125,y=315)
        self.txtyear = ttk.Combobox(self, value=["1st Year", "2nd Year", "3rd Year", "4th Year"], state="readonly", font=("Courier New", 13), textvariable=Student_YearLevel, width=31)
        ...
        self.add = Button(self, text="REGISTER", font=('Courier New', 11), height=1, width=10, bd=1,  bg="#FF9900", fg="black", command=add_stud)
        self.add.place(x=150,y=420)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Courier New', 11), height=1, width=10, bd=1, bg="#FF9900", fg="black", command=update_stud)
        ...
        self.delete = Button(self, text="DELETE", font=('Courier New', 11), height=1, width=10, bd=1, bg="#FF9900", fg="black", command=delete_stud)
        self.delete.place(x=450,y=420)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Courier New', 11, 'bold'),bd=0, bg= '#FF9900', fg="black", command=search_stud)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Courier New', 11, 'bold'), height=1, width=11,  bg="#FF9900", fg="black",command = display_stud)
        self.display.place(x=575,y=105)
        self.display.config(cursor= "hand2")
